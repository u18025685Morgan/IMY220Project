                        ...
                        <div class='card border-light shadow mb-5 rounded' id='". $cardColours[$count]."'>
                            <div class='card-body'>
                                ...
                                while($Ev = mysqli_fetch_array($resEv))
                                {
                                    ...
                                    {
                                        echo "<a id='listlink' href='event.php?event_id=". $Ev_id ."' class='list-group-item list-group-item-action flex-column align-items-start'>
                                            <div  class='d-flex w-100 justify-content-between'>
                                            <h5 class='mb-1'>". $Event['name'] ."</h5>
                                            <small>". $Event['date'] ."</small>
                                            </div>
                                            <p class='mb-1' id='description'>". $Event['description'] ."</p>
                                            <small id='loc'>". $Event['location'] ."</small>
                                        </a>";
                                    }
                                }
