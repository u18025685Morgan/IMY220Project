...
<body>
	...
	<div class="container">
		<div class="row">
            <div class="offset-lg-0 col-lg-3 offset-md-0 col-md-4 col-sm-6 offset-sm-3">
            ...
            <div class="offset-lg-0 col-lg-6 offset-md-0 col-md-8 col-sm-12">
					...
					<?php echo "<p id='pronoun'>". $pronouns ."</p>"; ?>
						<div class="profile-user-settings">
							...
							if($notme)
							{
								...
								if($wrw = mysqli_fetch_array($wrwRes))
								{
									...
									else
									{
										...
										<a class='btn btn-dark' href='chat.php?friend_id=". $userPage_id ."'>Message</a>";
									}
								}
								else
								{
							...
							}else
							{
								...
								<a class='btn profile-edit-btn' href='delete.php'>Delete Profile</a>";
							} ?>
						</div>
							...
							if($user_type == "admin")
								{
									...
									if($notme == false)
									{
										echo "<a class='btn' id='adminbutton' href='admin.php'>Admin Settings</a>";
									}
									else
									{
										echo "<a class='btn' id='adminbutton' href='delete.php?user_id=". $userPage_id."'>Delete User</a>";
										echo "<a class='btn profile-edit-btn' id='adminbutton' href='editprofile.php'>Edit Profile</a>";
									}
								}
							?>
						</div>
			...
			<div class="offset-lg-0 col-lg-3 col-md-6 offset-md-3">
							...
							while($myEvents = mysqli_fetch_array($myEventResults))
							{
								$myEventImageQuery = "SELECT image_name FROM tbgallery WHERE event_id ='$myEvents[event_id]'";
									...
									if($myEventImage = mysqli_fetch_array($myEventImageResult))
									{
										...
										echo	"
										<div class='col-lg-6 col-md-4 col-sm-6' id='". $myEvents['status']."'>
			...
			<div class="col-lg-6 col-sm-12">
				<?php if($notme)
					...
					<div class='row eventsGallery scroll' >";
							...
							$myEventAQuery = "SELECT * FROM tbreviews WHERE user_id = '$userPage_id'  ORDER BY review_date DESC";
								...
								while($attendedEvents = mysqli_fetch_array($attendeEventResults))
								{
									...
									if($myEventAImage = mysqli_fetch_array($myEventAImageResult))
									{
										...
										<div class='col-lg-6 col-md-4 col-sm-6'>
											...
											<div class='card border-light shadow mb-5 rounded' id='". $attendedEvents['status']."'>
					...
					<div class='row eventsGallery scroll' >";
							...
							$myEventAQuery = "SELECT * FROM tbreviews WHERE user_id = '$user_id' ORDER BY review_date DESC";
							$myEventAResults= $mysqli->query($myEventAQuery);
							while($myAEvents = mysqli_fetch_array($myEventAResults))
							{
								$attendedEventQuery = "SELECT * FROM tbevents WHERE event_id = '$myAEvents[event_id]'";
